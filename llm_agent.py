...
from tools import adb_shell, get_ui_tree, get_screenshot, search_installed_apps, get_device_info
...
## 注意事项
- input text 只支持英文和数字，中文输入需要借助其他方式（如剪贴板）
- 某些操作可能需要多步完成，耐心逐步执行
- 如果操作没有效果，尝试换一种方式
"""
...
phone_agent = Agent(
    ...
    tools=[adb_shell, get_ui_tree, get_screenshot, search_installed_apps, get_device_info],
